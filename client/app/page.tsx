    ...
    <main className="min-h-screen bg-gradient-to-b from-[#0b0f1a] via-[#0f1526] to-[#0b0f1a] text-gray-100">
      ...
      <header className="border-b border-white/10">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <h1 className="text-xl font-semibold tracking-wide text-yellow-400">XIV Tools</h1>
          <nav className="flex items-center gap-6 text-sm">
            <Link href="#" className="text-gray-300 hover:text-white">Outils</Link>
            <Link href="#" className="text-gray-300 hover:text-white">À propos</Link>
            <Link
              href="/login"
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        ...
        <p className="mb-8 max-w-2xl text-gray-300">
          Simplifiez vos soirées cartes aux trésors et la gestion de votre compagnie libre
          grâce à des outils clairs, rapides et partageables.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl">
            ...
            <p className="mb-6 text-sm text-gray-300">
              Créez et partagez des tableaux de répartition des gains pour vos soirées cartes
              aux trésors.
            </p>
            <Link
              href="/loot-tables"
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl opacity-70">
            ...
            <p className="mb-6 text-sm text-gray-300">
              Organisez les événements de votre CL avec un calendrier simple et partagé.
            </p>
            <span className="text-sm italic text-gray-400">Bientôt disponible</span>
          </div>
      ...
      <footer className="border-t border-white/10 py-6">
        <div className="mx-auto max-w-7xl px-6 text-sm text-gray-400 flex flex-col md:flex-row justify-between gap-4">
          ...
          <div className="flex gap-4">
            <Link href="#" className="hover:text-white">À propos</Link>
